...
const ManageDiscounts = () => {
  ...
  const addDiscount = async () => {
    try {
      ...
      const discountData = {
        ...values,
        applicablePackages: values.applicablePackages || [], // Ensure it's an array
      ...
      // Update the state with the new discount
      setDiscounts(prevDiscounts => [...prevDiscounts, response.data.discount]);
      setFilteredDiscounts(prevFilteredDiscounts => [...prevFilteredDiscounts, response.data.discount]);
  ...
  const confirmDelete = async () => {
    try {
      ...
      // Update the state by removing the deleted discount
